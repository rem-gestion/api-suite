...
const (
	...
	AddressService_Get_FullMethodName    = "/address.v1.AddressService/Get"
)
...
type AddressServiceClient interface {
	Create(ctx context.Context, in *CreateAddressRequest, opts ...grpc.CallOption) (*CreateAddressResponse, error)
...
func (c *addressServiceClient) Create(ctx context.Context, in *CreateAddressRequest, opts ...grpc.CallOption) (*CreateAddressResponse, error) {
...
func (c *addressServiceClient) Get(ctx context.Context, in *GetAddressRequest, opts ...grpc.CallOption) (*GetAddressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AddressServiceServer interface {
	Create(context.Context, *CreateAddressRequest) (*CreateAddressResponse, error)
...
func (UnimplementedAddressServiceServer) Create(context.Context, *CreateAddressRequest) (*CreateAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedAddressServiceServer) Get(context.Context, *GetAddressRequest) (*GetAddressResponse, error) {
